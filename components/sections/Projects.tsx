  ...
  return (
    <Section id="projects" tone="light">
      ...
      {items.length === 0 ? (
        ...
        <div className="mt-12 rounded-3xl border-2 border-dashed border-forest/15 bg-mint/40 p-10 text-center">
        ...
        <ul className="mt-14 grid gap-6 md:grid-cols-2">
          {items.map((project) => {
            ...
            return (
              <li
                key={project.slug}
                className="group flex flex-col rounded-3xl border border-forest/10 bg-offwhite p-8 transition-all duration-200 hover:-translate-y-1 hover:border-emerald/40 hover:shadow-[0_12px_32px_-12px_rgba(2,51,22,0.25)]"
              >
